...
// This code is modified from a UserScript made to test GM_config
// Changes have been made to support strict typing and follow TSLint settings
// Original file (MIT-licensed): https://github.com/sizzlemctwizzle/UserScripts/blob/master/gm_config_unit_test.user.js
...
GM_config.init({
  ...
  events: {
    open(doc) {
      ...
      const customCSS = GM_config.fields['customCSS']
        .node as HTMLInputElement | null
      const validCSS = GM_config.fields['validCSS']
        .node as HTMLInputElement | null
